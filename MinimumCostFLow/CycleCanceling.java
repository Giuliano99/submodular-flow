...
public class CycleCanceling {
    ...
    protected void initializeSpecialFlow() {
        graph.graph[0].get(0).augment(2);
        graph.graph[0].get(2).augment(0);
        graph.graph[1].get(1).augment(1);
        graph.graph[2].get(1).augment(0);
