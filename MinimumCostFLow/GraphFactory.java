...
public class GraphFactory {
    ...
    protected GraphList genTest() {
        startNode = 0;
        endNode = 2;
        nrOfNodes = 4;
        GraphList g;
        g = new GraphList(nrOfNodes, startNode, endNode);
        g.addEdge(startNode, 1, 2,1);
        g.addEdge(1, 2, 2,1);
        g.addEdge(2, startNode, 2,1);
        g.addEdge(startNode, 2, 2,1);
...
*/
    ...
    protected GraphList generateLineGraph() {
        ...
        for (int i = 0; i < endNode; i++) {
            g.addEdge(i, i + 1, getRandomNumber() + 1, getRandomNumber());
        }
        return g;
    }
